package com.netstatx.meow.snowflake.api.gen;
...
public final class SnowflakeServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest,
      com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID> METHOD_GET_UUID =
      io.grpc.MethodDescriptor.<com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest, com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "proto.SnowflakeService", "GetUUID"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID.getDefaultInstance()))
          .build();
  ...
  public static abstract class SnowflakeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getUUID(com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest request,
        io.grpc.stub.StreamObserver<com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest,
                com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID>(
  ...
  public static final class SnowflakeServiceBlockingStub extends io.grpc.stub.AbstractStub<SnowflakeServiceBlockingStub> {
    ...
    /**
     */
    public com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID getUUID(com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest request) {
  ...
  public static final class SnowflakeServiceFutureStub extends io.grpc.stub.AbstractStub<SnowflakeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID> getUUID(
        com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_UUID:
          serviceImpl.getUUID((com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.EmptyRequest) request,
              (io.grpc.stub.StreamObserver<com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.Snowflake.UUID>) responseObserver);
          break;
        default:
  ...
  private static final class SnowflakeServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.netstatx.meow.snowflake.api.gen.SnowflakeProtos.getDescriptor();
    }
  }
